<%@ Page Title="" Language="C#" MasterPageFile="~/Page/MasterPage.master" AutoEventWireup="true" CodeFile="Summary.aspx.cs" Inherits="Page_Summary" %>
                ...
                <ItemTemplate>
                    ...
                    <div class="message" <%# string.IsNullOrEmpty(Eval("DD_Reply").ToString()) ? "style='display:none;'" : "" %>>
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" CssClass="message-submit"
                            ...
                            Enabled='<%# string.IsNullOrEmpty(Eval("DF_ID").ToString()) ? true : false %>'
                            >不同意</asp:LinkButton>
                        <asp:LinkButton ID="LinkButton3" runat="server" CssClass="message-submit"
                                        OnCommand="On_Command" CommandName='<%# Eval("DD_ID") %>' CommandArgument="del"
                        >刪除</asp:LinkButton>
