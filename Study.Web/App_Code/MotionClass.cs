...
/// <summary>
/// Summary description for MotionResult
/// </summary>
public class MotionClass
{
    ...
    public static void Get_Dialog_Detail(string DM_ID, string sentence, string now_date)
    {
        DIALOG_DETAIL.ASK data_ask = SQLFunc.Get_DIALOG_DETAIL(DM_ID, "0", sentence, now_date, now_date);
